...
## Antes do discente regularizar o vinculo
...
* as datas para o lançamento de notas do período que acabou de encerrar
* as datas para o lançamento das ofertas no novo período que está começando
* as datas para o requerimento de matrícula on-line pelo discente
* as datas para o ajuste de matrícula on-line pelo discente para os cursos no regime crédito
* as datas para a solicitação de ajuste via protocolo virtual, para analise pela coordenação

> Discente

Cabe ao discente:

* Identificar o regime do seu curso, acessando a [lista de cursos](https://ufmt.br/ensino/busca?text=&modality=PRESENCIAL&type=&campus=&period=) no Portal da UFMT;
* Acessar o Portal Acadêmico (acessando o Portal de Sistemas Integrados e buscando por 'portal acadêmico') e verificar:
    * A situação acadêmica atual, na área 'Dados do Estudante';
    * As disciplinas pendentes de conclusão, acessando o seu Fluxograma;
    * Se não há pendencia no lançamento de notas, acessando o seu Histórico;
* Identificar as disciplinas que o curso ofertou no novo semestre;

> Docente

* Certificar-se de, após lançar as notas e frequências, deve também homologar os registros realizados dentro do prazo estabelecido para o lançamento de notas;
...
Provavelmente a coordenação do seu curso não ofertou todas as disciplinas que você precisa fazer. Verifique a oferta de disciplinas do curso e se você está com as notas lançandas em todas as disciplinas do seu histórico
...
Se seu curso é de regime crédito, aguarde o prazo e tente realizar o ajuste de matrícula
